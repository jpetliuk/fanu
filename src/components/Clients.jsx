const Clients = () => {
   ...
   return (
      ...
      >
         <h2 className="italic text-[#FEE085] text-3xl sm:text-4xl font-bold">CLIENTS</h2>
         ...
         <div className="flex items-center sm:mb-4 flex-wrap justify-center sm:mt-12 mt-5">
            <img
               ...
               class="h-15 w-40 sm:h-20 sm:w-50 object-contain hover:scale-105 duration-300 cursor-pointer"
            />
            <img
            ...
            <img
               ...
               alt="Tempos Logo"
               class="h-15 w-60 sm:h-20 sm:w-65 object-contain hover:scale-105 duration-300 cursor-pointer"
            />
         </div>
